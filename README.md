...
- [`docs/roadmap.md`](docs/roadmap.md) — Shipped v0.2.0 helpers and the remaining backlog
...
> The path to v1.0.0 (v1 features shipped in v0.2.0; the remaining gates are non-code) is tracked in [`docs/roadmap-v1.md`](docs/roadmap-v1.md).
